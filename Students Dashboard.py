...
def display_dash_board(student_names, marks):
    data_base = dict(zip(student_names,
                         marks))  # https://stackoverflow.com/questions/57143342/how-do-you-find-percentile-for-the-values-of-a-dictionary-in-python/57143740#57143740
    ...
    for k, v in sorted_data_base:  # https://stackoverflow.com/questions/57143342/how-do-you-find-percentile-for-the-values-of-a-dictionary-in-python
        percentile25 = v > 25
        percentile75 = v < 75
        if (percentile25) and (percentile75):
            print(k, v)
    print()
    for k, v in top5_students:  # https://stackoverflow.com/questions/57143342/how-do-you-find-percentile-for-the-values-of-a-dictionary-in-python
        print(k, v)
    print()
